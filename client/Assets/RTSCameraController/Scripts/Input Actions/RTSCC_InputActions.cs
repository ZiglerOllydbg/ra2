...
//     version 1.11.2
//     from Assets/RTSCameraController/Scripts/Input Actions/RTSCC_InputActions.inputactions
//
...
public partial class @RTSCC_InputActions: IInputActionCollection2, IDisposable
{
    ...
    ~@RTSCC_InputActions()
    {
        UnityEngine.Debug.Assert(!m_RTSCC.enabled, "This will cause a leak and performance issues, RTSCC_InputActions.RTSCC.Disable() has not been called.");
    }
