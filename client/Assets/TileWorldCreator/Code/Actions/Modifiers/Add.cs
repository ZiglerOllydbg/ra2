...
namespace TWC.Actions
{
	...
	[ActionNameAttribute(Name="Add")]
	public class Add : TWCBlueprintAction, ITWCAction
	{
		...
		public bool[,] Execute(bool[,] map, TileWorldCreator _twc)
		{
			...
			{
				int _mapSizeX = _twc.twcAsset.mapWidth; //_fromMap.GetLength(0);
				int _mapSizeY = _twc.twcAsset.mapHeight; //_fromMap.GetLength(1);
