...
namespace TWC
{
	...
	public struct TileDataStruct
	{
		...
		// public TileDataStruct (GameObject _tile)
		// {
		// 	tile = _tile;
		// }
	}
	...
	public class WorldMap
	{
		...
		/// TileData: Tile data
		/// </summary>
		public Dictionary<int, Dictionary<Vector2Int, TileDataStruct>> clusters = new Dictionary<int, Dictionary<Vector2Int, TileDataStruct>>();
		...
		public WorldMap(WorldMap _oldMap, int _width, int _height)
		{
			...
			clusters = new Dictionary<int, Dictionary<Vector2Int, TileDataStruct>>();
		}
		...
		public void AddTile(Vector3 _position, TileDataStruct _tileData)
		{	
			...
			{
				var _gridObject = new Dictionary<Vector2Int, TileDataStruct>();
