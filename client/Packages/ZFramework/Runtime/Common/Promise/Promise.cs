...
namespace ZLib.Promises
{
    ...
    public interface IPromise<PromisedT>
    {
        ...
        /// </summary>
        void Done(Action<PromisedT> onResolved, Action<PromiseException> onRejected);
        ...
        /// Handle errors for the promise. 
        /// </summary>
        IPromise<PromisedT> Catch(Func<PromiseException, PromisedT> onRejected);
        ...
        /// </summary>
        IPromise Then(Func<PromisedT, IPromise> onResolved, Action<PromiseException> onRejected);

        /// <summary>
        /// Add a resolved callback and a rejected callback.
        /// </summary>
        IPromise Then(Action<PromisedT> onResolved, Action<PromiseException> onRejected);
        ...
        /// The resolved callback chains a non-value promise.
        /// </summary>
        IPromise Then(Func<PromisedT, IPromise> onResolved, Action<PromiseException> onRejected, Action<float> onProgress);

        /// <summary>
        /// Add a resolved callback, a rejected callback and a progress callback.
        /// </summary>
        IPromise Then(Action<PromisedT> onResolved, Action<PromiseException> onRejected, Action<float> onProgress);
    ...
    public interface IRejectable
    {
        ...
        /// </summary>
        void Reject(PromiseException ex);
    }
    ...
    public class Promise<PromisedT> : IPromise<PromisedT>, IPendingPromise<PromisedT>, IPromiseInfo
    {
        ...
        public Promise(Action<Action<PromisedT>, Action<PromiseException>> resolver)
        {
            this.CurState = PromiseState.Pending;
            this.id = Promise.NextId();
...
//            Argument.NotNull(() => ex);
        ...
        /// onRejected is called on error.
        /// </summary>
        public void Done(Action<PromisedT> onResolved, Action<PromiseException> onRejected)
        {
        ...
        /// Handle errors for the promise.
        /// </summary>
        public IPromise<PromisedT> Catch(Func<PromiseException, PromisedT> onRejected)
        {
            if (CurState == PromiseState.Resolved)
            {
                return this;
        ...
        /// The resolved callback chains a non-value promise.
        /// </summary>
        public IPromise Then(Func<PromisedT, IPromise> onResolved, Action<PromiseException> onRejected)
        {
            return Then(onResolved, onRejected, null);
        }
        ...
        /// Add a resolved callback and a rejected callback.
        /// </summary>
        public IPromise Then(Action<PromisedT> onResolved, Action<PromiseException> onRejected)
        {
            return Then(onResolved, onRejected, null);
        }
        ...
        /// The resolved callback chains a non-value promise.
        /// </summary>
        public IPromise Then(Func<PromisedT, IPromise> onResolved, Action<PromiseException> onRejected, Action<float> onProgress)
        {
            if (CurState == PromiseState.Resolved)
            {
                try
                ...
                {
                    Promise.ReportException(cbEx);
                    return Promise.Rejected(new PromiseException(cbEx.Message, cbEx));
                }
            }
        ...
        /// Add a resolved callback, a rejected callback and a progress callback.
        /// </summary>
        public IPromise Then(Action<PromisedT> onResolved, Action<PromiseException> onRejected, Action<float> onProgress)
        {
            if (CurState == PromiseState.Resolved)
            {
                try
...
//            Argument.NotNull(() => transform);
        ...
        /// </summary>
        private void ActionHandlers(IRejectable resultPromise, Action<PromisedT> resolveHandler, Action<PromiseException> rejectHandler)
        {
            if (CurState == PromiseState.Resolved)
            {
        ...
        /// </summary>
        public static IPromise<PromisedT> Rejected(PromiseException ex)
        {
//            Argument.NotNull(() => ex);
