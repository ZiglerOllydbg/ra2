...
namespace ZLib.Promises
{
    ...
    public interface IPromise
    {
        ...
        /// </summary>
        void Done(Action onResolved, Action<PromiseException> onRejected);
        ...
        /// </summary>
        IPromise Catch(Action<PromiseException> onRejected);
        ...
        /// </summary>
        IPromise<ConvertedT> Then<ConvertedT>(Func<IPromise<ConvertedT>> onResolved, Func<PromiseException, IPromise<ConvertedT>> onRejected);

        /// <summary>
        /// Add a resolved callback and a rejected callback.
        /// The resolved callback chains a non-value promise.
        /// </summary>
        IPromise Then(Func<IPromise> onResolved, Action<PromiseException> onRejected);

        /// <summary>
        /// Add a resolved callback and a rejected callback.
        /// </summary>
        IPromise Then(Action onResolved, Action<PromiseException> onRejected);

        /// <summary>
        /// Add a resolved callback, a rejected callback and a progress callback.
        /// The resolved callback chains a value promise (optionally converting to a different value type).
        /// </summary>
        IPromise<ConvertedT> Then<ConvertedT>(Func<IPromise<ConvertedT>> onResolved, Func<PromiseException, IPromise<ConvertedT>> onRejected, Action<float> onProgress);

        /// <summary>
        /// Add a resolved callback, a rejected callback and a progress callback.
        /// The resolved callback chains a non-value promise.
        /// </summary>
        IPromise Then(Func<IPromise> onResolved, Action<PromiseException> onRejected, Action<float> onProgress);

        /// <summary>
        /// Add a resolved callback, a rejected callback and a progress callback.
        /// </summary>
        IPromise Then(Action onResolved, Action<PromiseException> onRejected, Action<float> onProgress);
    ...
    {
        internal ExceptionEventArgs(PromiseException exception)
        {
            //            Argument.NotNull(() => exception);

            this.PromiseException = exception;
        }

        public PromiseException PromiseException
        {
            get;
            private set;
        }
    ...
    public struct RejectHandler
    {
        ...
        /// Callback fn.
        /// </summary>
        public Action<PromiseException> callback;
    ...
    public class Promise : IPromise, IPendingPromise, IPromiseInfo
    {
        ...
        public static Action<Exception> ReportException;
        ...
        /// </summary>
        private PromiseException rejectionException;
        ...
        public Promise(Action<Action, Action<PromiseException>> resolver)
        {
            this.CurState = PromiseState.Pending;
            this.id = NextId();
            if (EnablePromiseTracking)
            ...
            {
                Reject(new PromiseException(cbEx.Message, cbEx));
                Promise.ReportException(cbEx);
            }
        }
        ...
        /// </summary>
        private void AddRejectHandler(Action<PromiseException> onRejected, IRejectable rejectable)
        {
        ...
        /// </summary>
        private void InvokeRejectHandler(Action<PromiseException> callback, IRejectable rejectable, PromiseException value)
        {
            ...
            {
                rejectable.Reject(new PromiseException(cbEx.Message, cbEx));
                Promise.ReportException(cbEx);
            }
        }
        ...
        /// </summary>
        private void InvokeRejectHandlers(PromiseException ex)
        {
            //            Argument.NotNull(() => ex);
        ...
        /// onRejected is called on error.
        /// </summary>
        public void Done(Action onResolved, Action<PromiseException> onRejected)
        {
        ...
        /// Handle errors for the promise. 
        /// </summary>
        public IPromise Catch(Action<PromiseException> onRejected)
        {
            ...
            Action<PromiseException> rejectHandler = ex =>
            {
                try
                {
                    onRejected(ex);
                ...
                {
                    resultPromise.Reject(new PromiseException(cbEx.Message, cbEx));
                    Promise.ReportException(cbEx);
                }
            };
        ...
        /// The resolved callback chains a value promise (optionally converting to a different value type).
        /// </summary>
        public IPromise<ConvertedT> Then<ConvertedT>(Func<IPromise<ConvertedT>> onResolved, Func<PromiseException, IPromise<ConvertedT>> onRejected)
        {
        ...
        /// The resolved callback chains a non-value promise.
        /// </summary>
        public IPromise Then(Func<IPromise> onResolved, Action<PromiseException> onRejected)
        {
            return Then(onResolved, onRejected, null);
        }
        ...
        /// Add a resolved callback and a rejected callback.
        /// </summary>
        public IPromise Then(Action onResolved, Action<PromiseException> onRejected)
        {
            return Then(onResolved, onRejected, null);
        }
        ...
        public IPromise<ConvertedT> Then<ConvertedT>(
            ...
            Func<PromiseException, IPromise<ConvertedT>> onRejected,
            Action<float> onProgress)
        {
            if (CurState == PromiseState.Resolved)
            {
                ...
                {
                    Promise.ReportException(cbEx);
                    return Promise<ConvertedT>.Rejected(new PromiseException(cbEx.Message, cbEx));
                }
            }
        ...
        /// The resolved callback chains a non-value promise.
        /// </summary>
        public IPromise Then(Func<IPromise> onResolved, Action<PromiseException> onRejected, Action<float> onProgress)
        {
            if (CurState == PromiseState.Resolved)
            {
                try
                ...
                {
                    return Rejected(new PromiseException(cbEx.Message, cbEx));
                }
            }
            ...
            Action<PromiseException> rejectHandler;
            if (onRejected != null)
            {
                rejectHandler = ex =>
                {
        ...
        /// Add a resolved callback, a rejected callback and a progress callback.
        /// </summary>
        public IPromise Then(Action onResolved, Action<PromiseException> onRejected, Action<float> onProgress)
        {
            if (CurState == PromiseState.Resolved)
            {
                try
        ...
        /// </summary>
        private void ActionHandlers(IRejectable resultPromise, Action resolveHandler, Action<PromiseException> rejectHandler)
        {
            if (CurState == PromiseState.Resolved)
            {
        ...
        /// </summary>
        public static IPromise Rejected(PromiseException ex)
        {
            //            Argument.NotNull(() => ex);
        ...
        public IPromise Finally(Action onComplete)
        {
            ...
            this.Catch(e =>
            {
                ...
                {
                    promise.Reject(new PromiseException(cbEx.Message, cbEx));
                    Promise.ReportException(cbEx);
                }
            });
        ...
        /// </summary>
        internal static void PropagateUnhandledException(object sender, PromiseException ex)
        {
