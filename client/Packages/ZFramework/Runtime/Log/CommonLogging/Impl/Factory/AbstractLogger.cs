...
namespace Common.Logging.Factory
{
    ...
    public abstract class AbstractLogger : ILog
    {
        ...
        /// </summary>
        protected delegate void WriteHandler(LogLevel level, object message, Exception exception, bool writeOnly = false);
        ...
        protected abstract void WriteInternal(LogLevel level, object message, Exception exception, bool writeOnly = false);
        ...
        /// </summary>
        /// <param name="message">The message object to log.</param>
        /// <param name="writeOnly">The message object to log write only.</param>
        public virtual void Debug(object message, bool writeOnly)
        {
            if (IsDebugEnabled)
                Write(LogLevel.Debug, message, null, writeOnly);
        }
        ...
        /// <param name="writeOnly">The message object to log write only.</param>
        public virtual void Debug(object message, Exception exception, bool writeOnly)
        {
            if (IsDebugEnabled)
                Write(LogLevel.Debug, message, exception, writeOnly);
        }
        ...
        /// <param name="message">The message object to log.</param>
        /// <param name="writeOnly">The message object to log write only.</param>
        public virtual void Warn(object message, bool writeOnly)
        {
            if (IsWarnEnabled)
                Write(LogLevel.Warn, message, null, writeOnly);
        }
        ...
        /// <param name="writeOnly">The message object to log write only.</param>
        public virtual void Warn(object message, Exception exception, bool writeOnly)
        {
            if (IsWarnEnabled)
                Write(LogLevel.Warn, message, exception, writeOnly);
        }
        ...
        /// <param name="message">The message object to log.</param>
        /// <param name="writeOnly">The message object to log write only.</param>
        public virtual void Error(object message, bool writeOnly)
        {
            if (IsErrorEnabled)
                Write(LogLevel.Error, message, null, writeOnly);
        }
        ...
        /// <param name="writeOnly">The message object to log write only.</param>
        public virtual void Error(object message, Exception exception, bool writeOnly)
        {
            if (IsErrorEnabled)
                Write(LogLevel.Error, message, exception, writeOnly);
        }
