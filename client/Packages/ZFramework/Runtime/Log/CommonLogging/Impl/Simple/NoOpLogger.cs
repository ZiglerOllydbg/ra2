...
namespace Common.Logging.Simple
{
    ...
    public sealed class NoOpLogger : ILog
    {
        ...
        public void Debug(object message, bool writeOnly)
        {
            // NOP - no operation
        }
        ...
        /// <param name="e"></param>
        /// <param name="writeOnly"></param>
        public void Debug(object message, Exception e, bool writeOnly)
        {
            // NOP - no operation
        }
        ...
        /// <param name="message"></param>
        /// <param name="writeOnly"></param>
        public void Warn(object message, bool writeOnly)
        {
            // NOP - no operation
        }
        ...
        /// <param name="e"></param>
        /// <param name="writeOnly"></param>
        public void Warn(object message, Exception e, bool writeOnly)
        {
            // NOP - no operation
        }
        ...
        /// <param name="message"></param>
        /// <param name="writeOnly"></param>
        public void Error(object message, bool writeOnly)
        {
            // NOP - no operation
        }
        ...
        /// <param name="e"></param>
        /// <param name="writeOnly"></param>
        public void Error(object message, Exception e, bool writeOnly)
        {
            // NOP - no operation
        }
