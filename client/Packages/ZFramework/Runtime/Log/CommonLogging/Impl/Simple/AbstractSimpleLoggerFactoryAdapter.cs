...
namespace Common.Logging.Simple
{
    ...
    public abstract class AbstractSimpleLoggerFactoryAdapter : AbstractCachingLoggerFactoryAdapter
    {
        ...
        protected AbstractSimpleLoggerFactoryAdapter(NameValueCollection properties)
            : this(
                    ArgUtils.TryParseEnum(LogLevel.All, ArgUtils.GetValue(properties, "Log_Level")),
                    ArgUtils.TryParse(true, ArgUtils.GetValue(properties, "Show_Date_Time")),
                    ArgUtils.TryParse(true, ArgUtils.GetValue(properties, "Show_Log_Name")),
                    ArgUtils.TryParse(true, ArgUtils.GetValue(properties, "Show_Level")),
                    ArgUtils.GetValue(properties, "Date_Time_Format", string.Empty)
                )
        { }
