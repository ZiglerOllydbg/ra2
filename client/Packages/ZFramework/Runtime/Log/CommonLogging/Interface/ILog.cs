...
namespace Common.Logging
{
    ...
    public interface ILog
    {
        ...
        void Debug(object message, bool writeOnly);
        ...
        /// <param name="message">The message object to log.</param>
        /// <param name="exception">The exception to log, including its stack trace.</param>
        /// <param name="writeOnly">Write Only.</param>
        void Debug(object message, Exception exception, bool writeOnly);
        ...
        /// <param name="message">The message object to log.</param>
        /// <param name="writeOnly">The message object to log write only.</param>
        void Warn(object message, bool writeOnly);
        ...
        /// <param name="exception">The exception to log, including its stack trace.</param>
        /// <param name="writeOnly">The message object to log write only.</param>
        void Warn(object message, Exception exception, bool writeOnly);
		...
		/// <param name="message">The message object to log.</param>
        /// <param name="writeOnly">The message object to log write only.</param>
		void Error(object message, bool writeOnly);
        ...
        /// <param name="exception">The exception to log, including its stack trace.</param>
        /// <param name="writeOnly">The message object to log write only.</param>
        void Error(object message, Exception exception, bool writeOnly);
